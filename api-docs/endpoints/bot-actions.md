...
- **events** => (Array) Struct BotEvent 
	...
	- **event_type** => i32 [ex 0]
	- **ts** => string [ex "2022-05-26T09:49:47.567687270Z"]
    ...
    "events": [
        {
            "id": "Some UUID here",
            "event_type": 0,
            "ts": "2022-05-26T09:49:47.567687270Z",
...
- **bot** => Struct Bot 
 ...
 => string [ex "value"]
	...
	- **events** => (Array) Struct BotEvent 
		- **id** => string [ex "Some UUID here"]
		- **event_type** => i32 [ex 0]
		- **ts** => string [ex "2022-05-26T09:49:47.567766490Z"]
		- **reason** => string [ex "Some reason here"]
		- **css** => string [ex "Some CSS here"]
        ...
        "events": [
            {
                "id": "Some UUID here",
                "event_type": 0,
                "ts": "2022-05-26T09:49:47.567766490Z",
                "reason": "Some reason here",
                "css": "Some CSS here"
            }
        ],
...
- **flags** => (Array) 
- **created_at** => string [ex "2022-05-26T09:49:47.567852826Z"]
...
```json
{
    ...
    "flags": [],
    "created_at": "2022-05-26T09:49:47.567852826Z"
}
```
...
- **events** => (Array) Struct BotEvent 
	- **id** => string [ex "Some UUID here"]
	- **event_type** => i32 [ex 0]
	- **ts** => string [ex "2022-05-26T09:49:47.567863755Z"]
	- **reason** => string [ex "Some reason here"]
	- **css** => string [ex "Some CSS here"]
    ...
    "events": [
        {
            "id": "Some UUID here",
            "event_type": 0,
            "ts": "2022-05-26T09:49:47.567863755Z",
            "reason": "Some reason here",
            "css": "Some CSS here"
        }
    ],
...
- **events** => (Array) Struct BotEvent 
	- **id** => string [ex "Some UUID here"]
	- **event_type** => i32 [ex 0]
	- **ts** => string [ex "2022-05-26T09:49:47.567919298Z"]
	- **reason** => string [ex "Some reason here"]
	- **css** => string [ex "Some CSS here"]
    ...
    "events": [
        {
            "id": "Some UUID here",
            "event_type": 0,
            "ts": "2022-05-26T09:49:47.567919298Z",
            "reason": "Some reason here",
            "css": "Some CSS here"
        }
    ],
